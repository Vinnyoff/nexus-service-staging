...
export const primaryNavItems: NavItem[] = [
  ...
  { href: "/schedule", icon: Calendar, label: "Agenda", roles: ["admin", "gerente", "encarregado", "tecnico"], permissionKey: "dashboard", mobileKey: "schedule", hidden: true },
  ...
  { href: "/location", icon: MapPinned, label: "Localização", roles: ["admin", "gerente", "encarregado", "tecnico"], permissionKey: "location", mobileKey: "location", hidden: true },
  { href: "/planning", icon: CalendarCheck, label: "Planejamento", roles: ["admin", "gerente", "encarregado"], permissionKey: "planning", mobileKey: "planning", hidden: true },
